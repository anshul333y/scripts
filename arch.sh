...
pacman -S --noconfirm reflector cronie dash zsh starship stow 7zip unzip man-db ffmpeg imagemagick \
  ...
  foot kitty wl-clipboard zoxide eza bat tmux neovim luarocks lazygit fzf ripgrep ast-grep fd htop btop \
...
# installing font | installing aur helper yay | installing aur packages
