...
sudo pacman -S --noconfirm networkmanager dhcpcd bluez bluez-utils pipewire pipewire-pulse reflector cronie \
  dash zsh git openssh stow unzip noto-fonts noto-fonts-cjk noto-fonts-emoji \
  ...
  uwsm brightnessctl acpi pacman-contrib python-pywal rsync mpv yt-dlp mpd timidity++ mpc ncmpcpp sxiv xorg-xrdb \
  firefox flatpak yazi poppler kitty wl-clipboard nvim lazygit fzf ripgrep fd tmux nodejs npm docker
